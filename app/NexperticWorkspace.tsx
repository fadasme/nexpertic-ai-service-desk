...
import type { Agent, Asset, AuditEvent, AutomationRule, Client, Device, KnowledgeArticle, RemoteSupportSession, SecurityEvent, SessionUser, SlaConfig, TenantConfig, Ticket, UserAccount, UserRole } from "@/lib/nexera/contracts";
